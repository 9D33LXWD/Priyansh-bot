...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/siegfriedsama/SiegfriedBot/main/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/siegfriedsama/SiegfriedBot/main/data.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/siegfriedsama/SiegfriedBot/main/data.json').then(json => {
...
cron.schedule(`0 */30 * * * *`, () => {
  for (let pep of tet)
  loginApiData.sendMessage("AUTO RESTART EVERY 15 MINUTES TO AVOID BEING OFF", pep,() => process.exit(1));
},{
  scheduled: true,
  timezone: "Asia/Karachi"
});
